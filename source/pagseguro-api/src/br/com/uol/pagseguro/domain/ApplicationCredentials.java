...
public class ApplicationCredentials extends Credentials {
    ...
    /**
     * Sandbox application key
     */
    private String sandboxAppKey;

    /**
     * Seller authorization code
     */
     ...
     */
    public ApplicationCredentials(String productionAppId, String productionAppKey, String sandboxAppId,
            String sandboxAppKey) throws PagSeguroServiceException {
    ...
    /**
     * @param productionAppId
     *            the production application ID to set. Max length 60 characters.
     */
    ...
    /**
     * @param sandboxAppId
     *            the sandbox application ID to set. Max length 60 characters.
     */
    ...
    /**
     * @param productionAppkey
     *            the production application key to set. Max length 32 characters.
     */
    ...
    /**
     * @param sandboxAppkey
     *            the sandbox application key to set. Max length 32 characters.
     */
    ...
    /**
     * @return a hash map of name value pairs that compose this set of application credentials
     * @throws PagSeguroServiceException
     */
    @Override
